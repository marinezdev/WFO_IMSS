...
namespace WFO_IMSSPortal.AccesoDatos
{
    internal sealed class ManejoDatos
    {
        ...
        internal int InsertUpdateDeleteWithTransaction()
        {
            ...
            {
                WFO_IMSSPortal.RegistraLog.RegistraLog log = new RegistraLog.RegistraLog("Log", HttpContext.Current.Server.MapPath("~"), "WFO Error Datos");
