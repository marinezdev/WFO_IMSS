...
{
    public partial class ResumenImssMando : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("ResumenMM");
                var worksheet = excel.Workbook.Worksheets["ResumenMM"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 18;

                using (ExcelRange Rng = worksheet.Cells["B2:I2"])
                {
                    Rng.Value = "RESUMEN DEL ENLACE DE ENTRADA IMSS 13/2019 MANDO";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Cifras_Imss_Activos.xlsx", Encoding.UTF8));
