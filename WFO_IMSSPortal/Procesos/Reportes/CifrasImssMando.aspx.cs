...
{
    public partial class CifrasImssMando : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("CifrasMM");
                var worksheet = excel.Workbook.Worksheets["CifrasMM"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 17;

                using (ExcelRange Rng = worksheet.Cells["B2:J2"])
                {
                    Rng.Value = "CIFRAS CONTROL DE MOVIMIENTOS POR DELEGACION - METLIFE MANDO: 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("CifrasImssMando.xlsx", Encoding.UTF8));
