...
{
    public partial class ResumenIMSSActivos : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("ResumenAA");
                var worksheet = excel.Workbook.Worksheets["ResumenAA"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 18;

                using (ExcelRange Rng = worksheet.Cells["B2:I2"])
                {
                    Rng.Value = "RESUMEN DEL ENLACE DE ENTRADA IMSS 13/2019 ACTIVOS";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("ResumenImssActivos.xlsx", Encoding.UTF8));
