...
{
    public partial class CifrasImssActivos : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("CifrasAA");
                var worksheet = excel.Workbook.Worksheets["CifrasAA"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 17;

                using (ExcelRange Rng = worksheet.Cells["B2:J2"])
                {
                    Rng.Value = "CIFRAS CONTROL DE MOVIMIENTOS POR DELEGACION - METLIFE ACTIVOS: 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("CifrasimssActivos.xlsx", Encoding.UTF8));
