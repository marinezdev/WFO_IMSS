...
{
    public partial class ResumenImssEstatutoA : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("ResumenEA");
                var worksheet = excel.Workbook.Worksheets["ResumenEA"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 18;

                using (ExcelRange Rng = worksheet.Cells["B2:I2"])
                {
                    Rng.Value = "RESUMEN DEL ENLACE DE ENTRADA IMSS 13/2019 ESTATUTO A";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("ResumenImssEstatutoA.xlsx", Encoding.UTF8));
