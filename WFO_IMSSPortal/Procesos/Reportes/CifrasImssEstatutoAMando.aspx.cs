...
{
    public partial class CifrasImssEstatutoAMando : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("CifrasAM");
                var worksheet = excel.Workbook.Worksheets["CifrasAM"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 17;

                using (ExcelRange Rng = worksheet.Cells["B2:J2"])
                {
                    Rng.Value = "CIFRAS CONTROL DE MOVIMIENTOS POR DELEGACION - METLIFE ESTATUTO A MANDO: 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                using (ExcelRange Rng = worksheet.Cells["B3"])
                {
                    ...
                    Rng.Style.Fill.PatternType = ExcelFillStyle.Solid;
                    Rng.Style.Fill.BackgroundColor.SetColor(System.Drawing.ColorTranslator.FromHtml("#3366FF"));
                    Rng.Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    Rng.Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                }
                ...
                using (ExcelRange Rng = worksheet.Cells["J3"])
                {
                    Rng.Value = "REPROG.";
                    Rng.AutoFitColumns(12);
                    Rng.Merge = true;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("CifrasImssEstatutoAMando.xlsx", Encoding.UTF8));
