...
{
    public partial class AcusesEntregaImagenesEstatutoA : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("ESTATUTO A");
                var worksheet = excel.Workbook.Worksheets["ESTATUTO A"];
                ...
                {
                    Rng.Value = "REPORTE DE CARTAS DE INSTRUCCION ESTATUTO A QUINCENA 201913 METLIFE";
                    Rng.Merge = true;
                    Rng.Style.Border.Bottom.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Right.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Left.Style = ExcelBorderStyle.Medium;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("AcusesEntregaImagenesEstatutoA.xlsx", Encoding.UTF8));
