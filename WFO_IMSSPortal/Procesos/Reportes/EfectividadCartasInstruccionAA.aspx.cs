...
{
    public partial class EfectividadCartasInstruccionAA : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("EfectividadCartasInstruccionAA.xlsx", Encoding.UTF8));
