...
{
    public partial class EfectividadCartasInstruccionEM : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                {
                    Rng.Value = "IMSS NOMINA DE ESTATUTO A MANDO QUINCENA 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("EfectividadCartasInstruccionEM.xlsx", Encoding.UTF8));
