...
{
    public partial class EfectividadCartasInstruccion : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                {
                    Rng.Value = "IMSS QUINCENA 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                var worksheet2 = excel.Workbook.Worksheets["Hoja1"];
                worksheet2.CustomHeight = true;

                using (ExcelRange Rng = worksheet2.Cells["A1"])
                {
                    Rng.Value = "Año/Quincena";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                    Rng.AutoFitColumns(17);
                    Rng.Style.Font.Bold = true;
                    Rng.Style.Font.Size = 11;
                    Rng.Style.Font.Color.SetColor(System.Drawing.ColorTranslator.FromHtml("#000000"));
                    Rng.Style.Fill.PatternType = ExcelFillStyle.Solid;
                    Rng.Style.Fill.BackgroundColor.SetColor(System.Drawing.ColorTranslator.FromHtml("#C5D9F1"));
                    Rng.Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    Rng.Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                }

                using (ExcelRange Rng = worksheet2.Cells["B1"])
                {
                    Rng.Value = "(Todas)";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                using (ExcelRange Rng = worksheet2.Cells["D14"])
                {
                    Rng.Value = "Tipo de nómina";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                    Rng.AutoFitColumns(18);
                    ...
                    Rng.Style.Font.Color.SetColor(System.Drawing.ColorTranslator.FromHtml("#00000"));
                    Rng.Style.Fill.PatternType = ExcelFillStyle.Solid;
                    Rng.Style.Fill.BackgroundColor.SetColor(System.Drawing.ColorTranslator.FromHtml("#C5D9F1"));
                    Rng.Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    Rng.Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                ...
                using (ExcelRange Rng = worksheet2.Cells["E14"])
                {
                    Rng.Value = "Tipo de Movimiento";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                    Rng.AutoFitColumns(30);
                    Rng.Style.Border.Top.Style = ExcelBorderStyle.Thin;
                    Rng.Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                    Rng.Style.Border.Right.Style = ExcelBorderStyle.Thin;
                    Rng.Style.Font.Bold = true;
                ...
                using (ExcelRange Rng = worksheet2.Cells["F14"])
                {
                    Rng.Value = "Total de movimientos";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                    Rng.AutoFitColumns(30);
                    Rng.Style.Border.Top.Style = ExcelBorderStyle.Thin;
                ...
                using (ExcelRange Rng = worksheet2.Cells["D15:F15"])
                {
                    Rng.Value = "Activos";
                    Rng.Merge = true;
                    Rng.Style.Border.Left.Style = ExcelBorderStyle.Thin;
                ...
                var worksheet3 = excel.Workbook.Worksheets["Reporte"];
                worksheet3.CustomHeight = true;

                #endregion

                #region Hoja 4

                excel.Workbook.Worksheets.Add("Casos Especiales");
                var worksheet4 = excel.Workbook.Worksheets["Casos Especiales"];
                worksheet4.CustomHeight = true;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("EfectividadCartasInstruccion.xlsx", Encoding.UTF8));
