...
{
    public partial class EfectividadCartasInstruccionMM : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                {
                    Rng.Value = "IMSS NOMINA DE MANDO QUINCENA 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("EfectividadCartasInstruccionMM.xlsx", Encoding.UTF8));
