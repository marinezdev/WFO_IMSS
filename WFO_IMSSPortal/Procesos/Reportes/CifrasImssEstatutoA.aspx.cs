...
{
    public partial class CifrasImssEstatutoA : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("CifrasEA");
                var worksheet = excel.Workbook.Worksheets["CifrasEA"];
                worksheet.CustomHeight = true;
                worksheet.DefaultRowHeight = 17;

                using (ExcelRange Rng = worksheet.Cells["B2:J2"])
                {
                    Rng.Value = "CIFRAS CONTROL DE MOVIMIENTOS POR DELEGACION - METLIFE ESTATUTO A: 2019-13";
                    Rng.Merge = true;
                    Rng.AutoFitColumns();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("CifrasImssEstatutoA.xlsx", Encoding.UTF8));
