...
{
    public partial class AcusesEntregaImagenesActivos : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                //Hoja 1
                excel.Workbook.Worksheets.Add("ACTIVOS");
                var worksheet = excel.Workbook.Worksheets["ACTIVOS"];
                ...
                {
                    Rng.Value = "REPORTE DE CARTAS DE INSTRUCCION ACTIVOS QUINCENA 201913 METLIFE";
                    Rng.Merge = true;
                    Rng.Style.Border.Bottom.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Right.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Left.Style = ExcelBorderStyle.Medium;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("AcusesEntregaImagenesActivos.xlsx", Encoding.UTF8));
