...
{
    public partial class AcusesEntregaImagenesMando : System.Web.UI.Page
    {
        ...
        public void GenerarReporte()
        {
            ...
            {
                // NOMBRE DE LA HOJA
                excel.Workbook.Worksheets.Add("MANDO");
                var worksheet = excel.Workbook.Worksheets["MANDO"];
                ...
                {
                    Rng.Value = "REPORTE DE CARTAS DE INSTRUCCION MANDO QUINCENA 201913 METLIFE";
                    Rng.Merge = true;
                    Rng.Style.Border.Bottom.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Right.Style = ExcelBorderStyle.Medium;
                    Rng.Style.Border.Left.Style = ExcelBorderStyle.Medium;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("AcusesEntregaImagenesMando.xlsx", Encoding.UTF8));
