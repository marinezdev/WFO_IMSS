...
namespace WFO_IMSSPortal.Procesos.Supervision
{
    public partial class sprDetalleHoras :Utilerias.Comun
    {
        ...
        {
            i.supervision.detallehoras.DatosDetalleHoras(ref dvgdProductividad, ref cmbUsuarios, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
