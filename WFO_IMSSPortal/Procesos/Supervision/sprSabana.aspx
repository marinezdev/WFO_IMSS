<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="sprSabana.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.Supervision.sprSabana" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <div class="text-warning text-center">SÁBANA  (LA GENERACIÓN DE ESTE REPORTE PUEDE DEMORAR MÁS DE 1 MINUTO)</div>
    <br />
    <br />
