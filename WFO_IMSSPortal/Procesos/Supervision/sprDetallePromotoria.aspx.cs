...
namespace WFO_IMSSPortal.Procesos.Supervision
{
    public partial class sprDetallePromotoria : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            i.supervision.detallepromotoria.DatosResumenPromotoria(ref dvgdResumenPromotoria,  CalDesde.Date, CalHasta.Date);
        }
        ...
        protected void dvgdDetallePromotoria_Init(object sender, EventArgs e)
        {
            ...
            gridDetalle.DataSource = i.supervision.detallepromotoria.DatosDetallePromotoria(CalDesde.Date.ToString(), CalHasta.Date.ToString(),idPromotoria);
        }
    }
}