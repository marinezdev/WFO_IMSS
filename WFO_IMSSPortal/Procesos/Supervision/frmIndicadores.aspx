<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmIndicadores.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.Supervision.frmIndicadores" MasterPageFile="~/Utilerias/Site.Master"%>
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8 col-xs-12 text-xs-right">
                                                                    <asp:Button ID="btnFiltrarM" CssClass="btn btn-primary" runat="server" Text="Ver" ClientIDMode="Static" />
                                                                </div>
                                                                <div class="row">
