...
namespace WFO_IMSSPortal.Procesos.Supervision
{
    public partial class sprReporteProductividad : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            i.supervision.reporteproductividad.DatosProductividad(ref dvgdProductividad, ref cmbUsuarios, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
        protected void listUsuario_Init(object sender, EventArgs e)
        {
            ASPxListBox listaUsuarios = (ASPxListBox)sender;
            DataTable dtD = i.supervision.reporteproductividad.DatosUsuarios(cmbFlujo.SelectedValue.ToString());
        ...
        protected void dvgdDetalleProducividad_Init(object sender, EventArgs e)
        {
            ...
            gridDetalle.DataSource = i.supervision.reporteproductividad.DatosDetalleProductividad(CalDesde.Date.ToString(), CalHasta.Date.ToString(), usuario, mesaNombre, cmbFlujo.SelectedValue.ToString());
        }
