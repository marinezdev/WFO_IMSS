...
namespace WFO_IMSSPortal.Procesos.Supervision
{
    public partial class sprReporteGeneralFranja : Utilerias.Comun
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            cmbFlujoF.DataSource = i.supervision.default_.DatosComboFlujo();
            cmbFlujoF.DataTextField = "Nombre";
            cmbFlujoF.DataValueField = "Id";
            cmbFlujoF.DataBind();
            cmbFlujoTS.DataSource = i.supervision.default_.DatosComboFlujo();
            cmbFlujoTS.DataTextField = "Nombre";
            cmbFlujoTS.DataValueField = "Id";
            cmbFlujoTS.DataBind();
            cmbFlujoT.DataSource = i.supervision.default_.DatosComboFlujo();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            i.supervision.reportegeneralfranja.MostrarDatosFranja(ref dvgdFranja,ref dvchtFranja,CalFranja.Date, cmbFlujoF.SelectedValue.ToString());
            i.supervision.reportegeneralfranja.AcumuladoMensualFranja(ref lblAcumulado,CalFranja.Date, cmbFlujoF.SelectedValue.ToString());
            string annio = AnnioTS.SelectedValue;
            string mes = MesTS.SelectedValue;
            i.supervision.reportegeneralfranja.LlenarDatosTS(ref dvgdTramiteSemana,ref dxChtTotalesTS, mes, annio, cmbFlujoTS.SelectedValue.ToString());
            i.supervision.reportegeneralfranja.MostrarDatosTendencia(ref dvgdTendencia,ref dvchtTendencia, cmbFlujoT.SelectedValue.ToString());
