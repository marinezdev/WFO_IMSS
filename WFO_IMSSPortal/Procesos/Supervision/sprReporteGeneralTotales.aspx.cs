...
namespace WFO_IMSSPortal.Procesos.Supervision 
{
    public partial class sprReporteGeneralTotales : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            i.supervision.reportegeneraltotales.llenarDatos(ref dvgdTotales, ref dxChtTotales,CalDesde.Date.ToString(),CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
