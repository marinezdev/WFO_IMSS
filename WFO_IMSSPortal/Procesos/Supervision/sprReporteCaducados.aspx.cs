...
namespace WFO_IMSSPortal.Procesos.Supervision
{
    public partial class sprReporteCaducados : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            i.supervision.reportecaducados.DatosReporteCaducados(ref dvgdEstatusTramite, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
