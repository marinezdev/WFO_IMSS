        ...
        protected void BtnConsultar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (FechaCalculada.AddMonths(-3).AddDays(-1) <= Fecha2)
                {
                    ...
                    //List <prop.Tramite> Tramites = supervisiongeneraltramites.TramiteSupervicionGeneralSelecionar(manejo_sesion.Usuarios.IdUsuario, Fecha1, Fecha2, Folio, RFC, Nombre, ApPaterno, ApMaterno);
                    RepeaterFechas.DataSource = i.supervisiongeneral.tramite.prueba(manejo_sesion.Usuarios.IdUsuario, Fecha1, Fecha2, Folio, RFC, Nombre, ApPaterno, ApMaterno);
