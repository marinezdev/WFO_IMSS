<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="EnlaceAgregarCasosEspeciales.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.IMSSPortal.EnlaceAgregarCasosEspeciales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Enlace. Casos Especiales (particulares)</h2>
...
-->
                                ...
                                <tr>
                                    <td colspan="3">
                                        <strong>Cartas de Casos Especiales</strong>

                                        <ajaxToolkit:AjaxFileUpload ID="AjaxFileUploadCartas" runat="server" AllowedFileTypes="pdf" Width="100%" OnUploadComplete="AjaxFileUploadCartas_UploadComplete" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="right"><strong>Quincena de Enlace a Aplicar:</strong>&nbsp;&nbsp;&nbsp;</td>
                                    <td>
                                        <asp:TextBox ID="txtQuincenaEnlace" runat="server" Text=""> </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">&nbsp;</td>
