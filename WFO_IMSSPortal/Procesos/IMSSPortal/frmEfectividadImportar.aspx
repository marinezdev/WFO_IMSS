<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="frmEfectividadImportar.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.IMSSPortal.frmEfectividadImportar" %>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:DropDownList ID="ddlTipoNomina" runat="server" Width="200px" class="form-control">
                                            ...
                                            <asp:ListItem Value="AA" Text="General" ></asp:ListItem>
