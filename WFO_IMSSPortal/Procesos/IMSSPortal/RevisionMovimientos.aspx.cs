...
{
    public partial class RevisionMovimientos : Utilerias.Comun
    {
        ...
        {
            i.imssportal.tramites.eliminarRegistroMovimientos(e.Keys[grid.KeyFieldName].ToString());
            Busqueda();
            e.Cancel = true;
        }
        ...
        private void Busqueda()
        {
            ...
            //}
            i.imssportal.tramites.ObtenerMovimientos_AspxGridView(ref grid, DDLQuincena.SelectedValue);
        }
