...
{
    public partial class frmEfectividadImportar : Utilerias.Comun
    {
        ...
        protected void BtnExcelAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                switch (int.Parse(ddlTipoArchivo.SelectedValue))
                {
                    case 1:
                        i.imssportal.extraccion.ProcesarExcel_Efectividad(pagina, manejo_sesion.Usuarios.IdUsuario, strFolio, txtObservaciones.Text.Trim());
                    ...
                    case 2:
                        ...
                        // No se utiliza
                        ////////i.imssportal.extraccion.ProcesarExcelConcentrado(pagina, manejo_sesion.Usuarios.IdUsuario, strFolio, txtObservaciones.Text.Trim());
                        ////////lblProcesadoExcel.ForeColor = System.Drawing.Color.Blue;
                        ////////i.imssportal.tramites.ObtenerExtaccion_GridView(ref GVExtraccion, manejo_sesion.Usuarios.IdUsuario, strFolio);
                        ////////if (GVExtraccion.Rows.Count > 0)
                        ////////{
                    ...
                    default:
                        lblProcesadoExcel.Text = "Tipo de archivo inválido...";
