...
{
    public partial class EnlaceAgregarCasosI : Utilerias.Comun
    {
        ...
        protected void BtnExcelAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                i.imssportal.extraccion.ProcesarExcel_EnlaseCasosAdicionales(pagina, manejo_sesion.Usuarios.IdUsuario, strFolio, "", Server.MapPath("~/EnlaceCasosEspeciales/"), txtQuincenaEnlace.Text.Trim(), ref TotalCasos);
