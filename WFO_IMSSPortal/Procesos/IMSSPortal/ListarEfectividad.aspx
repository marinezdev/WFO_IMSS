<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarEfectividad.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.IMSSPortal.ListarEfectividad" MasterPageFile="~/Utilerias/Site.Master" %>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <asp:DropDownList ID="DDLTipoNomina" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="GG" Text="General (AA, EA, MM)" ></asp:ListItem>
                                    </asp:DropDownList>
