...
{
    public partial class frmExtraccion : Utilerias.Comun
    {
        ...
        protected void BtnExcelAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 1:
                        i.imssportal.extraccion.ProcesarExcel(pagina, manejo_sesion.Usuarios.IdUsuario, strFolio, txtObservaciones.Text.Trim());
