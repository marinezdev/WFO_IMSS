...
{
    public partial class ListarEfectividad : Utilerias.Comun
    {
        ...
        protected void lnkExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                //dsEfectividad = i.imssportal.tramites.ObtenerEfectividad_DataSet(DDLTipoNomina.SelectedValue, DDLQuincena.SelectedValue);
                //Efectividad_GenerarXLS(dsEfectividad, DDLQuincena.SelectedValue.ToString(), DDLTipoNomina.SelectedValue.ToString());
                //Funciones.ManejoExcel.ExportarDataSetAExcel(this, dsEfectividad);

                //grid.DataSource = dsEfectividad;
                //grid.DataBind();
                //grid.ExportXlsxToResponse("Efectividad.xlsx", new XlsxExportOptionsEx() { ExportType = ExportType.WYSIWYG });
        ...
        { 
            ...
            using (ExcelPackage excel = new ExcelPackage(newFile))
            {
                ...
                if (TipoNomina == "GG")
                {
                    strReporteEfectividad = "Reporte de efectividad de Cartas Instrucción IMSS " + Quincena + " GENERAL";
                }
                else
                {
                    strReporteEfectividad = "Reporte de efectividad de Cartas Instrucción IMSS " + Quincena + " " + TipoNomina.ToUpper();
                }
                strReporteEfectividad = "Efectividad";
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (DDLTipoNomina.SelectedValue.ToString() != "" && DDLQuincena.SelectedValue.ToString() != "00")
            {
                ...
                i.imssportal.tramites.ObtenerEfectividad_AspxGridView(ref gridConcentrado, ref gridEfectividad, DDLTipoNomina.SelectedValue, DDLQuincena.SelectedValue);
            }
