<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="EnlaceListar.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.IMSSPortal.EnlaceListar" %>
    ...
    <asp:UpdatePanel ID="upPnlCaptura" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Enlace. Movimientos con Crédito Insuficiente</h2>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="width: 20px; text-align:center">
                                            <%# Eval("AplicaEnlace").ToString() == "True" ? "<a href='EnlaceListar.aspx?Quincena=" + cboQuicena.SelectedValue.ToString() + "&TipoNimina=" + cboTipoNomina.SelectedValue.ToString() + "&Activar=" + Eval("EnlaceClave").ToString() + "'><img src='../../Imagenes/acpetado.jpg' alt='Aplicar Enlace' /></a>" : "<a href='EnlaceListar.aspx?Quincena=" + cboQuicena.SelectedValue.ToString() + "&TipoNimina=" + cboTipoNomina.SelectedValue.ToString() + "&Activar=" + Eval("EnlaceClave").ToString() + "'><img src='../../Imagenes/rechazado.jpg' alt='No Aplicar Enlace' /></a>" %>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
