    ...
    public partial class CartaRechazo : Utilerias.Comun
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    List<prop.carta> carta = i.promotoria.cartas.Consulta_Carta(IdTramite, "Rechazo",0);
                    if (carta.Count > 0)
                    {
        ...
        private void MuestraPDF(prop.carta carta)
        {
            ...
            cell = new PdfPCell(new Phrase("En atención a tu solicitud de contratación del seguro de " + Folio + " y con base en la información que nos proporcionaste, lamentamos comunicarte que después de revisar con detenimiento tu caso, no será posible proceder con la contratación del plan propuesto.", Text));
            cell.Colspan = 10;
