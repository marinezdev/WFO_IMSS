...
namespace WFO_IMSSPortal.Procesos.Promotoria
{
    public partial class NuevoTramire3 : Utilerias.Comun
    {
        ...
        {
            int Id = Funciones.Nums.TextoAEntero(LisProducto.SelectedValue.ToString());
            LisSbproductos(Id);
        }
        ...
        protected void LisNacionalidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LabelRespuestaNacionalidadFisico.Text = ValidaPais(Funciones.Nums.TextoAEntero(txNacionalidad.Value.ToString()));
        }

        protected void LisTitNacionalidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            LabelRespuestaNacionalidadTitular.Text = "";
            LabelRespuestaNacionalidadTitular.Text = ValidaPais(Funciones.Nums.TextoAEntero(txTiNacionalidad.Value.ToString()));
        }
        ...
        protected void CrearTramite()
        {
            if (ValidaExpediente())
            {
                ...
                List<prop.promotoria_usuario> Promotoria_Usuarios = i.promotoria.catalogos.Promotoria_Usuarios(manejo_sesion.Usuarios.IdUsuario);
                ...
                {
                    List<prop.agente_promotoria_usuario> agente_Promotoria_Usuarios = i.promotoria.catalogos.Agente_Promotoria_Usuarios(manejo_sesion.Usuarios.IdUsuario, txClaveAgente.Text.ToString());
                ...
                List<prop.RespuestaNuevoTramiteN1> respuestaNuevoTramiteN1s = i.promotoria.tramiten1.NuevoTramiteN1(NuevoTramite, null);
        ...
        protected void btnSubirDocumento_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpDocumento.HasFile)
            {
                ...
                if (".pdf".Contains(fileExtension) ^ ".jpg".Contains(fileExtension) ^ ".png".Contains(fileExtension))
                {
                    ...
                    {
                        List<prop.control_archivos> control_Archivos = i.promotoria.archivos.ControlArchivoNuevoID();
                        ...
                        {
                            LabRespuestaArchivosCarga.Text = "El archivo no se puede convertir a PDF.";
                        }
                    }
                    else
                    {
        ...
        protected void antecedentesRFC()
        {
            ...
            if (cboTipoContratante.SelectedValue.Equals("Fisica"))
            {
                ...
                List<prop.TramiteN1> tramiteN1s = i.promotoria.catalogos.BustatramiteN1RFC(RFC);
        ...
        {
            //List<prop.cat_producto> cat_Productos = i.promotoria.catalogos.Cat_productos(TipoTramite);
            ...
            //Funciones.LlenarControles.LlenarDropDownList(ref LisProducto, i.promotoria.catalogos.Cat_productos(TipoTramite), "Nombre", "Id");
            i.promotoria.catalogos.Cat_productos(ref LisProducto, TipoTramite);
        }

        private void LisSbproductos(int Id)
        {
            //List<prop.cat_subproducto> cat_Subproductos = i.promotoria.catalogos.Cat_subproductos(Id);
            ...
            i.promotoria.catalogos.Cat_subproductos(ref LisSubproducto, Id);
        }

        private void ListaMonedas()
        {
            //List<prop.cat_moneda> cat_monedas = i.promotoria.catalogos.Cat_Monedas();
            ...
            //Funciones.LlenarControles.LlenarDropDownList(ref cboMoneda, i.promotoria.catalogos.Cat_Monedas(), "Nombre", "Id");
            i.promotoria.catalogos.Cat_Monedas(ref cboMoneda);
        ...
        {
            //List<prop.cat_riesgos> cat_Riesgos = i.promotoria.catalogos.Cat_Riesgos();
            ...
            //Funciones.LlenarControles.LlenarDropDownList(ref LisRiesgos, i.promotoria.catalogos.Cat_Riesgos(), "Riesgo", "Id");
            i.promotoria.catalogos.Cat_Riesgos(ref LisRiesgos);
        }
        ...
        protected void MuestraDocumentos()
        {
            ...
            //lstDocumentos.DataTextField = "NmOriginal";
            //lstDocumentos.DataBind();
            Funciones.LlenarControles.LlenarListBox(ref lstDocumentos, LstArchivosDocumento, "NmOriginal", "Id");
        }
        ...
        protected void MuestraInsumos()
        {
            ...
            if (Session["insumos"] != null)
                LstArchivosInsumo = (List<prop.insumos>)Session["insumos"];
        ...
        {
            //List<prop.cat_pais> cat_pais = i.promotoria.catalogos.Cat_Paises();
            //objDDL.DataSource = cat_pais;
            //objDDL.TextField = "PaisNombre";
            //objDDL.ValueField = "Id";
            //objDDL.DataBind();

            Funciones.LlenarControles.LlenarAspxComboBox(ref objDDL, i.promotoria.catalogos.Cat_Paises(), "PaisNombre", "Id");
            objDDL.SelectedIndex = 135;
        }

        private void cargaPromotoria(int id)
        {
            List<prop.promotoria_usuario> Promotoria_Usuarios = i.promotoria.catalogos.Promotoria_Usuarios(id);
        ...
        {
            double total = 0;
            List<prop.cat_moneda> cat_Monedas = i.promotoria.catalogos.BuscaMonedaId(IdMoneda);
        ...
        private string ValidaPais(int Id)
        {
            ...
            List<prop.cat_pais> cat_Pais_Sancionado = i.promotoria.catalogos.cat_Pais_Sancionado(Id);
            string respuesta = "";
        ...
        private string registraDocumentosExpediente(int pIdTramite, int TipoTramite)
        {
            ...
            try
            {
                ...
                {
                    i.promotoria.archivos.Agregar_Expedientes_Tramite(TipoTramite, pIdTramite, IdControlArchivo, nombreFusion, "Archivo Fusion", 1, 1, "");
                    msgError = "";
                }
            }
