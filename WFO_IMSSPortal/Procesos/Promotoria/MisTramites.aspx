<%@ Page Title="" Language="C#" MasterPageFile="~/Utilerias/Site.Master" AutoEventWireup="true" CodeBehind="MisTramites.aspx.cs" Inherits="WFO_IMSSPortal.Procesos.Promotoria.MisTramites" %>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <asp:Label runat="server" ID="label1"  Font-Bold="True" Text="* Fecha termino" class="control-label col-md-2 col-sm-2 col-xs-6"></asp:Label>
                        ...
                        <asp:Label runat="server" ID="labelFechaSolicitud"  Font-Bold="True" Text="* Fecha inicio" class="control-label col-md-2 col-sm-2 col-xs-6"></asp:Label>
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                            <dx:ASPxDateEdit ID="dtFechaInicio" runat="server" Theme="Material" EditFormat="Custom" Width="100%" Caption="" AutoPostBack="true" OnDateChanged="ActualizaFechaTermino">
                                <TimeSectionProperties>
                                    <TimeEditProperties EditFormatString="dd/MM/yyyy" />
                                </TimeSectionProperties>
                                <CalendarProperties>
