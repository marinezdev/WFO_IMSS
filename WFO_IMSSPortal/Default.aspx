<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WFO_IMSSPortal.Default" %>
				...
				<hr>
                    <form id="form1" runat="server" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
                            ...
                            <ajaxToolkit:FilteredTextBoxExtender ID="ftb_txUsuario" runat="server" TargetControlID="txUsuario" FilterMode="ValidChars" ValidChars="1234567890abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ."></ajaxToolkit:FilteredTextBoxExtender>
					    </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
                            ...
                            <ajaxToolkit:FilteredTextBoxExtender ID="ftb_txClave" runat="server" TargetControlID="txClave" FilterMode="ValidChars" ValidChars="1234567890abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ."></ajaxToolkit:FilteredTextBoxExtender>
					    </div>                        
